...
?>
    ...
    <div class="container mt-4">
        ...
        <form action="" id="option_laptop" name="option_laptop" class="justify-content-center">
            ...
            <label for="laptop" class="h4 mb-3">Laptop:</label>
            ...
            <div id="form_n" hidden>
                ...
                <div class="row">
                    ...
                    <label for="n1" class="col-sm-2 col-form-label">Harga (Price)</label>
                    <div class="col-sm-10">
                    ...
                    <!-- processor -->
                    <label for="n2" class="col-sm-2 col-form-label">Processor</label>
                    <div class="col-sm-10">
                    ...
                    <!-- ram -->
                    <label for="n3" class="col-sm-2 col-form-label">RAM</label>
                    <div class="col-sm-10">
                    ...
                    <!-- hdd -->
                    <label for="n4" class="col-sm-2 col-form-label">Storage</label>
                    <div class="col-sm-10">
                    ...
                    <!-- baterai -->
                    <label for="n5" class="col-sm-2 col-form-label">Baterai Laptop</label>
                    <div class="col-sm-10">
                    ...
                    <!-- vga -->
                    <label for="n5" class="col-sm-2 col-form-label">VGA Card</label>
                    <div class="col-sm-10">
                    ...
                    <!-- layar -->
                    <label for="n5" class="col-sm-2 col-form-label">Ukuran Layar</label>
                    <div class="col-sm-10">
                    ...
                    $.ajax({
                        ...
                        success: function(dataResult) {
                            ...
                            if (dataResult.statusCode == 200) {
                                ...
                                alert("Error occured, harap isi semua data!");
                            }
                        }
                    });
                } else {
